...
namespace Projet_Exam_ASP.NetCore.Migrations
{
    ...
    [Migration("20220110064655_AjoutDesTables_Offre__Image")]
    partial class AjoutDesTables_Offre__Image
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projet_Exam_ASP.NetCore.Models.Offre", b =>
                {
                    ...
                    b.HasIndex("PropriétaireId");

                    b.ToTable("Offres");
                });

            modelBuilder.Entity("Projet_Exam_ASP.NetCore.Models.Propriétaire", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Projet_Exam_ASP.NetCore.Models.Image", b =>
                {
                    b.HasOne("Projet_Exam_ASP.NetCore.Models.Offre", null)
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Projet_Exam_ASP.NetCore.Models.Offre", b =>
                {
                    ...
                    b.HasOne("Projet_Exam_ASP.NetCore.Models.Propriétaire", "Propriétaire")
                        .WithMany("Offres")
                        .HasForeignKey("PropriétaireId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
